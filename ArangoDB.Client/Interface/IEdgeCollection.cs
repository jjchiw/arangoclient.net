...
namespace ArangoDB.Client
{
    public interface IEdgeCollection<T> : IArangoCollection<T>
    {
        ...
        DocumentIdentifierResult InsertEdge(string from, string to, object edgeDocument, bool? createCollection = null, bool? waitForSync = null, EventHandler<ArangoDatabaseEventArgs> evt = null);
        ...
        /// <param name="waitForSync">Wait until document has been synced to disk</param>
        /// <returns>Document identifiers</returns>
        Task<DocumentIdentifierResult> InsertEdgeAsync(string from, string to, object edgeDocument, bool? createCollection = null, bool? waitForSync = null, EventHandler<ArangoDatabaseEventArgs> evt = null);
        ...
        List<T> Edges(string vertexId, EdgeDirection? direction = null);
        ...
        /// <param name="direction">Selects in or out direction for edges. If not set, any edges are returned</param>
        /// <returns>Returns a list of edges starting or ending in the vertex identified by vertex document handle</returns>
        Task<List<T>> EdgesAsync(string vertexId, EdgeDirection? direction=null);
    }
}
